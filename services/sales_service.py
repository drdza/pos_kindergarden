...
def alta_venta(customer_name: str, seller_name: str,
               items_ui: list[dict], customer_id: int | None = None, seller_id: int | None = None,
    ...
    folio = sales_repo.create_sale(header, items, payments)
    return folio
